...
const CHILL_OUT_TIME = process.env.CHILL_OUT_TIME === undefined ? 3000 : Number(process.env.CHILL_OUT_TIME);
/**
...
(function (BrowserUtils) {
     ...
     */
    function getNumberOfElements(selector) {
        Reporter_1.Reporter.debug(`Get number of elements by selector '${selector}'`);
        return $$(selector).length;
    }
    BrowserUtils.getNumberOfElements = getNumberOfElements;
    /**
